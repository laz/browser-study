...
class Browser:
    def __init__(self):
        ...
        self.window.bind("<Command-Button-1>", self.handle_command_click)
    ...
    def handle_command_click(self, e):
        if e.y > self.chrome.bottom:
            tab_y = e.y - self.chrome.bottom
            self.active_tab.command_click(e.x, tab_y)
...
class Tab:
    ...
    def load(self, url):
        ...
        # print('forward')
        # for item in self.forward_history:
        #     print(item)
    ...
    def go_back(self):
        if len(self.history) > 1:
            ...
            self.forward_history.append(back)
...
class Chrome:
    def __init__(self, browser):
        ...
        self.forward_rect = Rect(
            ...
            self.urlbar_top + self.padding,
            self.back_rect.right + forward_width + self.padding,
            self.urlbar_bottom - self.padding
        )
    ...
    def paint(self):
        ...
        cmds.append(DrawText(self.forward_rect.left + self.padding, self.forward_rect.top, ">", self.font, "black"))
